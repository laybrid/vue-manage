<template>
    <div class="container">
        <h2>支持拖拽</h2>
        <el-upload class="upload-demo" drag action="http://localhost:3000/userImg" multiple
            :on-change="handleFileChange" :on-success="handleSuccess">
        ...
        <h2>测试自定义上传</h2>
        <el-upload class="upload-demo" action="#" multiple :http-request="customUpload">
            <el-button type="primary">Click to upload</el-button>
        </el-upload>
        <h4 v-if="result">文件展示:</h4>
        <img v-if="result" :src="result.url" alt="" style="width: 200px; height: 200px;">
    </div>
</template>
